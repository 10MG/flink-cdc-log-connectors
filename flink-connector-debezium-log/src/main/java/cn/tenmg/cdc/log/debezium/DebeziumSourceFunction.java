...
import cn.tenmg.cdc.log.debezium.internal.DebeziumChangeConsumer;
import cn.tenmg.cdc.log.debezium.internal.DebeziumChangeFetcher;
import cn.tenmg.cdc.log.debezium.internal.DebeziumOffset;
import cn.tenmg.cdc.log.debezium.internal.DebeziumOffsetSerializer;
import cn.tenmg.cdc.log.debezium.internal.FlinkDatabaseHistory;
import cn.tenmg.cdc.log.debezium.internal.FlinkDatabaseSchemaHistory;
import cn.tenmg.cdc.log.debezium.internal.FlinkOffsetBackingStore;
import cn.tenmg.cdc.log.debezium.internal.Handover;
import cn.tenmg.cdc.log.debezium.internal.SchemaRecord;

import javax.annotation.Nullable;

import static cn.tenmg.cdc.log.debezium.utils.DatabaseHistoryUtil.registerHistory;
import static cn.tenmg.cdc.log.debezium.utils.DatabaseHistoryUtil.retrieveHistory;
