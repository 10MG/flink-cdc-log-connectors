...
import cn.tenmg.cdc.log.connectors.mysql.LegacyMySqlSourceTest;
...
public class MySqlConnectorITCase extends MySqlSourceTestBase {
    ...
    public void testStartupFromSpecificOffset() throws Exception {
        ...
        Tuple2<String, Integer> offset =
                LegacyMySqlSourceTest.currentMySqlLatestOffset(
                        inventoryDatabase, "products", 9, useLegacyDezMySql);
