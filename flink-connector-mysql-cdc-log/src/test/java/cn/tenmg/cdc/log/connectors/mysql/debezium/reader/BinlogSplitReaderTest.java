...
import cn.tenmg.cdc.log.connectors.mysql.debezium.reader.BinlogSplitReader;
import cn.tenmg.cdc.log.connectors.mysql.debezium.reader.SnapshotSplitReader;
import cn.tenmg.cdc.log.connectors.mysql.debezium.task.context.StatefulTaskContext;
import cn.tenmg.cdc.log.connectors.mysql.source.MySqlSourceTestBase;
import cn.tenmg.cdc.log.connectors.mysql.source.assigners.MySqlBinlogSplitAssigner;
import cn.tenmg.cdc.log.connectors.mysql.source.assigners.MySqlSnapshotSplitAssigner;
...
import cn.tenmg.cdc.log.connectors.mysql.table.StartupOptions;
import cn.tenmg.cdc.log.connectors.mysql.testutils.RecordsFormatter;
...
import static cn.tenmg.cdc.log.connectors.mysql.source.utils.RecordUtils.getSnapshotSplitInfo;
import static cn.tenmg.cdc.log.connectors.mysql.source.utils.RecordUtils.getStartingOffsetOfBinlogSplit;
import static cn.tenmg.cdc.log.connectors.mysql.source.utils.RecordUtils.isHighWatermarkEvent;
