...
package cn.tenmg.cdc.log.connectors.mysql.debezium.dispatcher;
...
public class EventDispatcherImpl<T extends DataCollectionId> extends EventDispatcher<T> {
    ...
    private final class SchemaChangeEventReceiver implements SchemaChangeEventEmitter.Receiver {
        ...
        private Struct schemaChangeRecordValue(SchemaChangeEvent event) throws IOException {
            ...
            String fileName =
                    sourceInfo.getString(SignalEventDispatcher.BINLOG_FILENAME_OFFSET_KEY);
            Long pos = sourceInfo.getInt64(SignalEventDispatcher.BINLOG_POSITION_OFFSET_KEY);
            Long serverId =
                    sourceInfo.getInt64(
            ...
            source.put(SignalEventDispatcher.BINLOG_FILENAME_OFFSET_KEY, fileName);
            source.put(SignalEventDispatcher.BINLOG_POSITION_OFFSET_KEY, pos);
