...
import cn.tenmg.cdc.log.connectors.mysql.source.events.BinlogSplitMetaEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.BinlogSplitMetaRequestEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.FinishedSnapshotSplitsAckEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.FinishedSnapshotSplitsReportEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.FinishedSnapshotSplitsRequestEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.LatestFinishedSplitsSizeEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.LatestFinishedSplitsSizeRequestEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.SuspendBinlogReaderAckEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.SuspendBinlogReaderEvent;
import cn.tenmg.cdc.log.connectors.mysql.source.events.WakeupReaderEvent;
...
import cn.tenmg.cdc.log.connectors.mysql.source.split.MySqlBinlogSplitState;
import cn.tenmg.cdc.log.connectors.mysql.source.split.MySqlSnapshotSplit;
import cn.tenmg.cdc.log.connectors.mysql.source.split.MySqlSnapshotSplitState;
...
import cn.tenmg.cdc.log.connectors.mysql.source.utils.TableDiscoveryUtils;

import static cn.tenmg.cdc.log.connectors.mysql.source.events.WakeupReaderEvent.WakeUpTarget.SNAPSHOT_READER;
import static cn.tenmg.cdc.log.connectors.mysql.source.split.MySqlBinlogSplit.toNormalBinlogSplit;
import static cn.tenmg.cdc.log.connectors.mysql.source.split.MySqlBinlogSplit.toSuspendedBinlogSplit;
import static cn.tenmg.cdc.log.connectors.mysql.source.utils.ChunkUtils.getNextMetaGroupId;
