...
package cn.tenmg.cdc.log.connectors.mysql.source.config;

import org.apache.flink.annotation.Internal;

import cn.tenmg.cdc.log.connectors.mysql.debezium.EmbeddedFlinkDatabaseHistory;
...
public class MySqlSourceConfigFactory implements Serializable {
    ...
    private String serverTimeZone = MySqlSourceOptions.SERVER_TIME_ZONE.defaultValue();
    ...
    private double distributionFactorUpper =
            MySqlSourceOptions.SPLIT_KEY_EVEN_DISTRIBUTION_FACTOR_UPPER_BOUND.defaultValue();
    private double distributionFactorLower =
            MySqlSourceOptions.SPLIT_KEY_EVEN_DISTRIBUTION_FACTOR_LOWER_BOUND.defaultValue();
