...
import static cn.tenmg.cdc.log.debezium.DebeziumSourceFunction.LEGACY_IMPLEMENTATION_KEY;
import static cn.tenmg.cdc.log.debezium.DebeziumSourceFunction.LEGACY_IMPLEMENTATION_VALUE;
import static org.apache.flink.util.Preconditions.checkNotNull;

/**
 * A builder to build a SourceFunction which can read snapshot and continue to consume binlog.
 *
 * @deprecated please use {@link cn.tenmg.cdc.log.connectors.mysql.source.MySqlSource} instead
...
public class MySqlSource {
     ...
     *     cn.tenmg.cdc.log.connectors.mysql.source.MySqlSource#builder()} instead which
