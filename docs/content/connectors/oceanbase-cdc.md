    ...
    <table class="colwidths-auto docutils">
        ...
        <tbody>
            <tr>
                ...
                <td>String</td>
                <td>Specify what connector to use, here should be <code>'oceanbase-cdc-log'</code>.</td>
            </tr>
            <tr>
...
import OceanBaseSource;
import OceanBaseTableSourceFactory;
import StartupMode;
